...
class HubeiCrawler(Crawler):
    ...
    urls = {'host': 'http://www.egs.gov.cn/',
            'official_site': 'http://xyjg.egs.gov.cn/ECPS_HB/search.jspx',
            ...
            'ind_comm_pub_skeleton': 'http://xyjg.egs.gov.cn/ECPS_HB/businessPublicity.jspx?',
            'ent_pub_skeleton': 'http://xyjg.egs.gov.cn/ECPS_HB/enterprisePublicity.jspx?',
            'other_dept_pub_skeleton': 'http://xyjg.egs.gov.cn/ECPS_HB/otherDepartment.jspx?',
            'judical_assist_skeleton': 'http://xyjg.egs.gov.cn/ECPS_HB/justiceAssistance.jspx?',
