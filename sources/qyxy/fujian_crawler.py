...
class FujianCrawler(Crawler):
    ...
    def run(self, ent_number=0):
        ...
        self.html_restore_path = FujianCrawler.html_restore_path + self.ent_number + '/'
...
class TestParser(unittest.TestCase):
    ...
    def test_parse_shareholder_detail_page(self):
        with open('./enterprise_crawler/fujian/shareholder_detail.html') as f:
            page = f.read()
