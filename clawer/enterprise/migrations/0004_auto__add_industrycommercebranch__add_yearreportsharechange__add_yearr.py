...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('year_report_warrandice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creditor', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        # Adding model 'IndustryCommerceAdministrativePenalty'
        db.create_table('industry_commerce_administrative_penalty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('penalty_decision_num', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('illegal_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('penalty_content', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        db.send_create_signal('enterprise', ['IndustryCommerceAdministrativePenalty'])
        ...
        # Adding model 'IndustryCommerceMortgageDetailChange'
        db.create_table('industry_commerce_mortgage_detail_change', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('modify_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('modify_content', self.gf('django.db.models.fields.TextField')(null=True)),
            ('register_id', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ...
        db.send_create_signal('enterprise', ['IndustryCommerceMortgageDetailChange'])
        ...
        # Adding model 'IndustryCommerceMortgageDetailGuarantee'
        db.create_table('industry_commerce_cortgage_detail_guarantee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('check_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ...
        db.send_create_signal('enterprise', ['IndustryCommerceMortgageDetailGuarantee'])


        # Changing field 'Enterprise.name'
        db.alter_column('enterprise_enterprise', 'name', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'IndustryCommerceAdministrativePenalty'
        db.delete_table('industry_commerce_administrative_penalty')
        ...
        # Deleting model 'IndustryCommerceMortgageDetailChange'
        db.delete_table('industry_commerce_mortgage_detail_change')

        # Deleting model 'IndustryCommerceMainperson'
        db.delete_table('industry_commerce_mainperson')

        # Deleting model 'IndustryCommerceMortgageDetailGuarantee'
        db.delete_table('industry_commerce_cortgage_detail_guarantee')


        # Changing field 'Enterprise.name'
        db.alter_column('enterprise_enterprise', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'enterprise.industrycommerceadministrativepenalty': {
            'Meta': {'object_name': 'IndustryCommerceAdministrativePenalty', 'db_table': "'industry_commerce_administrative_penalty'"},
            'bas_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'corporation': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
        ...
        'enterprise.industrycommercemortgagedetailchange': {
            'Meta': {'object_name': 'IndustryCommerceMortgageDetailChange', 'db_table': "'industry_commerce_mortgage_detail_change'"},
            'enter_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invalidation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'enterprise.industrycommercemortgagedetailguarantee': {
            'Meta': {'object_name': 'IndustryCommerceMortgageDetailGuarantee', 'db_table': "'industry_commerce_cortgage_detail_guarantee'"},
        ...
        'enterprise.yearreportwarrandice': {
            ...
            'creditor': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
