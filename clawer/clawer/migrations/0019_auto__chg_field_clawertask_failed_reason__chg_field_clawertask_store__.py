...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ClawerTask.failed_reason'
        db.alter_column('clawer_clawertask', 'failed_reason', self.gf('django.db.models.fields.CharField')(max_length=4096, null=True))
    ...
    models = {
        ...
        'clawer.clawertask': {
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'store': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
